...
class UI {
    ...
    imprimirAlerta(mensaje, tipo) {
        ...
        setTimeout( () => {
             document.querySelector('.contenido .alert').remove();
        }, 3000);
   }
    ...
    agregarGastoListado(gastos) {
        ...
        gastos.forEach(gasto => {
            ...
            // Insertar el gasto
            nuevoGasto.innerHTML = `<span class="nombre"> ${nombre}</span> <span class="badge badge-primary badge-pill"> € ${cantidad}</span>`;
...
function preguntarPresupuesto() {
    const presupuestoUsuario = prompt('Introduce tu presupuesto mensual');
...
function agregarGasto(e) {
    e.preventDefault();
     ...
     if(nombre === '' || cantidad === '') {
          ...
          ui.imprimirAlerta('Importe incorrecto', 'error')
     } else {
